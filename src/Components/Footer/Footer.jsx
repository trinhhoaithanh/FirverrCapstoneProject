            ...
            <div className='row'>
                <div className='col-5'>
                    <div className='row'>
                        ...
                        <div className='col-8'>
                        <p className="text-body-2 legal"><span className="copyright text-trunc" style={{color:'#b5b6ba'}}>© Fiverr International Ltd. 2023</span></p>
                        </div>
                    </div>
                </div>
                <div className='col-7'>
                    <div className='row'>
                        ...
                        <div className='col-6'>
                            <div className='row'>
                                ...
                                <div className='col-4'>
                                    <span className='text-dark'>US$ USD</span>
                                </div>
                                <div className='col-4'>
